...
from sqlalchemy import Column, ForeignKey, Integer, String, DateTime, Index, func
...
class Block(Base):
    ...
    # custom index here because the field can get very big
    Index("idx_description", func.md5(description))
